...
#Аннотации для тестопса
@allure.feature('Посты')
@allure.story('Получение поста')
@allure.title('GET /posts/{post_id} возвращает корректный пост')
...
@allure.feature('Пост')
@allure.story('Получение поста')
@allure.title('GET /posts/1 возвращает корректный пост')
...
@allure.title('GET /users возвращает корректные данные о пользователе')
...
@allure.title('POST /posts возвращает корректные данные')
...
#Аннотации для тестопса
@allure.feature('Пост')
@allure.story('Несушествующий пост')
